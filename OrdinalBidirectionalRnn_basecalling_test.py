...
tb_path = '/mnt/nexenta/lanno001/nobackup/tensorboardFiles/ordinal_basecallTrain1/'
...
for (batch_size, cell_type, learning_rate, layer_size, optimizer, num_layers) in param_combos:
    ...
    graph_path = ('/mnt/nexenta/lanno001/nobackup/hpTraceGraphs/ordinalBasecallTrain1_%s_batchSize'
